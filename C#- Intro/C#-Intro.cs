...
Console.WriteLine($"The entered number is {num}. Then added 7 end of the number like this:{turnedNum},then found 7 percent of {turnedNum}, result is {result}");*/
#endregion
#region task-5
...
Console.WriteLine($"The entered number is {num}. Then added 4 in front of number and 44 end of the number like this:{turnedNum},then found 44 percent of {turnedNum}, result is {result}");*/
#endregion
#region task-6
...
Console.WriteLine($"The entered number is {num}. 20 percent of {num} is {percent20}. 10 percent of {percent20} is {percent10}.The final result is {result}.");*/
#endregion
#region task-7
...
double result = turnedInteger * .05;
Console.WriteLine($"Sum is {firstNum + secondNum}.Added 5 in front and end of number {turnedInteger}.5 percent of {turnedInteger} is {result}.");*/
